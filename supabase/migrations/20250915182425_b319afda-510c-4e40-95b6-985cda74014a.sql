...
-- Insert some sample job postings (using placeholder user IDs)
...
('Software Engineer', 'Join our team as a Software Engineer working on cutting-edge projects', 'Tech Corp', 'San Francisco, CA', 'full-time', '$80,000 - $120,000', ARRAY['Python', 'React', 'Node.js'], gen_random_uuid(), 'https://jobs.example.com/apply/123', now() + interval '30 days'),
('Marketing Intern', 'Summer internship opportunity in digital marketing', 'StartupXYZ', 'Remote', 'internship', '$15/hour', ARRAY['Social Media', 'Content Creation', 'Analytics'], gen_random_uuid(), 'https://jobs.example.com/apply/124', now() + interval '45 days');